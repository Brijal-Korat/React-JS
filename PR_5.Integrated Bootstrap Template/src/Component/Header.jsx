                            ...
                            <div className="cr-right-bar">
                                <ul className="navbar-nav">
                                    <li className="nav-item dropdown">
                                        <a className="nav-link dropdown-toggle cr-right-bar-item" href="javascript">
                                ...
                                <a href="javascript" className="cr-right-bar-item Shopping-toggle">
                ...
                <div className="container">
                    <div className="cr-menu-list">
                        ...
                        <nav className="navbar navbar-expand-lg">
                            <a href="javascript" className="navbar-toggler shadow-none">
