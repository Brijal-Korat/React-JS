    ...
    return (
        <section class="section-testimonial padding-b-100">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="cr-testimonial-slider swiper-container row">
                            <div class="swiper-wrapper cr-testimonial-pt-50 col-xl-4">
                                    <div class="cr-testimonial mx-2">
                                        <div class="cr-testimonial-image">
                                            <img src="/src/assets/img/testimonial/1.jpg" alt="businessman" />
                                        </div>
                                    ...
                                    <div class="cr-testimonial mx-2">
                                        <div class="cr-testimonial-image">
                                            <img src="/src/assets/img/testimonial/2.jpg" alt="businessman" />
                                        </div>
                                        <div class="cr-testimonial-inner">
                                            <span>Manager</span>
                                    ...
                                    <div class="cr-testimonial mx-2">
                                        <div class="cr-testimonial-image">
                                            <img src="/src/assets/img/testimonial/3.jpg" alt="businessman" />
                                        </div>
                                        <div class="cr-testimonial-inner">
